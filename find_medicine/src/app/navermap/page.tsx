   ...
   return (
      <div className="w-full h-[100vh] px-10 py-14 bg-[#2573D9] relative">
         <div
            id="map"
            ref={mapRef}
            style={{ width: '85%', height: '350px', margin: '0 auto', borderRadius: '10px' }}
         />
         ...
         <span
            className="block bg-[#49F2D3] text-[#1771e7] w-[85%] h-[40px] m-auto leading-10 text-center text-white text-lg font-bold rounded-md cursor-pointer hover:text-black hover:bg-[#1cc6a7] transition-all duration-300"
